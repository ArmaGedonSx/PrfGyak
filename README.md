...
│           ↓              ↓              ↓                    │
│  ┌────────────────┐ ┌────────────┐ ┌────────────┐          │
│  │  mean-app      │ │ Prometheus │ │  Grafana   │          │
│  │  (port 3000)   │ │ (port 9090)│ │ (port 3001)│          │
│  │  ┌──────────┐  │ │            │ │            │          │
│  │  │ Frontend │  │ │  Metrics   │ │ Dashboard  │          │
│  │  │ Angular  │  │ │ Collection │ │ Visualize  │          │
│  │  └──────────┘  │ │            │ │            │          │
│  │  ┌──────────┐  │ │  Scrapes   │ │ Data from  │          │
...
### Nginx Reverse Proxy (Egy URL alatt minden!)
- **Alkalmazás**: http://localhost/
- **Prometheus**: http://localhost/prometheus/
- **Grafana**: http://localhost/grafana/ (admin/admin)
- **Metrics**: http://localhost/metrics

### Direkt Portok (Alternatív elérés)
...
### Publikus URL (Ngrok)
```bash
# Indítsd el az ngrok-ot
ngrok http 80

# Minden service egy URL alatt:
# https://abc123.ngrok.io/           → Alkalmazás
# https://abc123.ngrok.io/prometheus → Prometheus
...
```bash
# Minden service egy URL alatt
http://localhost/              # Alkalmazás
http://localhost/prometheus/   # Prometheus
http://localhost/grafana/      # Grafana
```

**Direkt Portok (Alternatív):**
```bash
http://localhost:3000  # Alkalmazás
...
# https://abc123.ngrok.io/prometheus/
# https://abc123.ngrok.io/grafana/
```
